...
> 状态：草案，投票项见 §9，09-20 定 1.0；**本文件只定格式标准，MVP 动工等爸爸拍板**（Cora 规矩）
...
09-17 草案（本文件）→ 09-18 晚回票+补 Eve 注入攻防题 → 09-20 **1.0 定稿** → MVP 立项**等爸爸拍板**后由若若动代码、验收官跑 §8 全单。
